    ...
    public void ExibeMenuPaciente()
    {
        ...
        switch (MenuSelecao(modulo,cor))
        {
            case 1:
                ...
                MensagemSucesso.ConteudoMensagem("Paciente cadastrado com sucesso", ConsoleColor.Green);
            ...
            case 4:
                ...
                Console.Clear();
                MensagemSucesso.ConteudoMensagem("Paciente removido com sucesso!", ConsoleColor.Red);
                ExibeMenuPaciente();
                break;
        }
    }
